...
!(function (e) {
  ...
  (CRUMINA.fixedHeader = function () {
    ...
    (CRUMINA.parallaxFooter = function () {
      g.length &&
        g.hasClass("js-fixed-footer") &&
        (g.before('<div class="block-footer-height"></div>'),
            ...
            function () {
              ...
              i
                .circleProgress({
                  ...
                  emptyFill: "#fff",
                  lineCap: "round",
                  fill: { gradient: [t, o], gradientAngle: Math.PI / 4 },
                })
                .on("circle-animation-progress", function (e, t) {
                  i.find(".content").html(
                    parseInt(n * t, 10) + "<span>%</span>"
                  );
                })
    ...
    (CRUMINA.animateSvg = function () {
      c.length &&
        c.each(function () {
          jQuery(this).waypoint(
            function () {
              e(this.element).find("> svg").drawsvg().drawsvg("animate"),
                this.destroy();
            },
            { offset: "95%" }
          );
    ...
    (CRUMINA.customScroll = function () {
      setTimeout(function () {
        d.mCustomScrollbar(
          { axis: "y", scrollEasing: "linear", scrollInertia: 150 },
          500
        );
      });
    }),
    ...
    (CRUMINA.mediaPopups = function () {
      e(".js-popup-iframe").magnificPopup({
        ...
        iframe: {
          patterns: {
            youtube: { src: "https://www.youtube.com/embed/%id%?autoplay=1" },
            vimeo: { src: "https://player.vimeo.com/video/%id%?autoplay=1" },
          },
        },
      }),
    ...
    (CRUMINA.OurVisionScrollAnnimation = function () {
      ...
      new ScrollMagic.Scene({ triggerElement: ".our-vision" })
        ...
        .addTo(e),
        new ScrollMagic.Scene({ triggerElement: ".our-vision" })
          .setVelocity(".our-vision .eye", { opacity: 1, bottom: "-90" }, 1e3)
          .triggerHook(1)
          .addTo(e);
    }),
        ...
        i.isotope({
          ...
          i
            ...
            .on("click", function () {
              ...
              return void 0 !== t ? (i.isotope({ filter: t }), !1) : void 0;
            });
      });
    }),
    ...
    (CRUMINA.initSwiper = function () {
      ...
      e(".swiper-container").each(function () {
        ...
        o.addClass("swiper-" + a + " initialized").attr("id", a),
          o.find(".swiper-pagination").addClass("pagination-" + a);
          ...
          (n["swiper-" + a] = new Swiper(".swiper-" + a, {
            ...
            onSlideChangeStart: function (e) {
              if (o.find(".slider-slides").length) {
                o.find(".slider-slides .slide-active").removeClass(
                  "slide-active"
                );
                var i = e.slides
                  .eq(e.activeIndex)
                  .attr("data-swiper-slide-index");
                o.find(".slider-slides .slides-item")
                  .eq(i)
        ...
        e(".slider-slides .slides-item").on("click", function () {
          ...
          return (
            n[
              "swiper-" + e(this).closest(".swiper-container").attr("id")
            ].slideTo(i + 1),
            e(this).parent().find(".slide-active").removeClass("slide-active"),
            e(this).addClass("slide-active"),
            !1
          );
        });
    }),
    (CRUMINA.burgerAnimation = function () {
      ...
      function r(e) {
        e.draw(d, u, 0.7, { easing: ease.ease("elastic-out", 1, 0.3) });
      }
      function s(e) {
        e.draw(g, m, 0.7, {
          delay: 0.1,
    ...
    i.keydown(function (e) {
      27 == e.which &&
        (d.hasClass("opened") && CRUMINA.togglePanel(),
        o.hasClass("open") && CRUMINA.toggleSearch());
    }),
    ...
    jQuery(".js-popup-close").on("click", function () {
      return (
        e(".window-popup").removeClass("open"),
        o.removeClass("body-overflow"),
        !1
      );
    }),
    ...
    jQuery("#top-bar-js").on("click", function () {
      return (
        e(".top-bar").addClass("open"), o.toggleClass("overlay-enable"), !1
      );
    }),
    jQuery("#top-bar-close-js").on("click", function () {
      return (
        e(".top-bar").removeClass("open"), o.removeClass("overlay-enable"), !1
      );
    }),
    p.length &&
      p
    ...
    t.on("click", function (i) {
      e(i.target).closest(f).length ||
        (f.hasClass("visible") &&
          (f.fadeToggle(200), f.toggleClass("visible"))),
        e(i.target).closest(d).length ||
          (d.hasClass("opened") && CRUMINA.togglePanel());
    }),
    ...
    (CRUMINA.maps = {
      maps: {
        mapUSA: {
          ...
          markers: [
            { coords: [38.897663, -77.036575], icon: "marker-google.png" },
          ],
        },
      },
      init: function () {
          ...
          if (i.config && i.markers && document.getElementById(i.config.id)) {
            ...
            i.markers.forEach(function (e) {
              ...
              var t = L.icon(i.config.icon),
                n = L.marker(e.coords, { icon: t });
              o.addLayer(n);
            }),
              t.addLayer(o),
              this.disableScroll(jQuery("#" + i.config.id), t);
          }
        }
      },
    ...
    t.ready(function () {
      e("#menu-icon-wrapper").length && CRUMINA.burgerAnimation(),
        ...
        CRUMINA.progresBars(),
        CRUMINA.pieCharts(),
        e(".subscribe").length && CRUMINA.SubscribeScrollAnnimation(),
        e(".seo-score").length && CRUMINA.SeoScoreScrollAnnimation(),
        e(".testimonial-slider").length &&
          CRUMINA.TestimonialScrollAnnimation(),
        e(".our-vision").length && CRUMINA.OurVisionScrollAnnimation(),
        e(".background-mountains").length &&
